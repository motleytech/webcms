...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        u'cmsplugin_pybook.pybookfolderpath': {
            'Meta': {'object_name': 'PyBookFolderPath', '_ormbases': ['cms.CMSPlugin']},
            u'cmsplugin_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['cms.CMSPlugin']", 'unique': 'True', 'primary_key': 'True'}),
            'folderPath': ('django.db.models.fields.CharField', [], {'default': "'-- full path to folder --'", 'max_length': '250'})
        },
        u'cmsplugin_pybook.pybookpath': {
            'Meta': {'object_name': 'PyBookPath', '_ormbases': ['cms.CMSPlugin']},
            u'cmsplugin_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['cms.CMSPlugin']", 'unique': 'True', 'primary_key': 'True'}),
            'filePath': ('django.db.models.fields.CharField', [], {'default': "'-- full path to basic html file --'", 'max_length': '250'})
        }
    }
